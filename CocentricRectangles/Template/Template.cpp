...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("OpenGL Fixed Function Pipeline Using Native Windowing : Multi colored rectangles"),
...
void display(void)
{
	...
	void drawConcentricRectangles(struct Color[]);
	...
	drawConcentricRectangles(colors);

	SwapBuffers(ghdc);
	//glFlush();
}

void drawConcentricRectangles(struct Color colors[10])
{
	glLineWidth(1.0f);
	GLint colorIndex = 0;
