...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("OpenGL Fixed Function Pipeline Using Native Windowing : concentric circels"),
...
void display(void)
{
	...
	void drawConcentricCircles(struct Color[]);
...
void drawConcentricCircles(struct Color colors[10])
{
	GLint colorIndex = 0;
	GLfloat radius;
	glPointSize(1.0f);
